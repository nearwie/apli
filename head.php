	...
	<head>
		...
		<script type="text/javascript" src="hhttps://cdn.datatables.net/1.10.21/js/jquery.dataTables.min.js"></script>
		...
		<link rel="stylesheet" href="<?= base_url ('assets/'); ?>css/ui.jqgrid.css" >
